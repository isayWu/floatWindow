...
public class IFloatWindowImpl extends IFloatWindow {
    ...
    @Override
    public void updateXY(int x, int y, int moveType) {
        // mCanDrag = canDrag;

        cancelAnimator();

        mB.mMoveType = moveType;
//      mB.xTempOffset = mB.xOffset;
//      mB.yTempOffset = mB.yOffset;
...
//                                    newX = 0;
//                                }
//                                if (newX > Util.getScreenWidth(getView().getContext()) - mDefaultBtnSize) {
//                                    newX = Util.getScreenWidth(getView().getContext()) - mDefaultBtnSize;
//                                }
//                                if (newY < 0) {
//                                    newY = 0;
//                                }
//                                if (newY > Util.getScreenHeight(getView().getContext()) - mDefaultBtnSize) {
//                                    newX = Util.getScreenHeight(getView().getContext()) - mDefaultBtnSize;
//                                }
                                mFloatView.updateXY(newX, newY);
                                if (mB.mViewStateListener != null) {
